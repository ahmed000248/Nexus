...
import { Users, Bell, Calendar, TrendingUp, AlertCircle, PlusCircle, Video, FileCheck } from 'lucide-react';
...
// Week 2 dummy data (used to show counts on the dashboard quick-access cards)
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignore
          ...
          <CardBody>
            <div className="flex items-center mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Connect with investors face-to-face</p>
              </div>
            </div>
